...
/**
  * The basic unit of functionality for Peapod, each Task defines a node in the final dependency graph for Peapod. Tasks
  * can depend on other tasks using the dep functionality and generate an output.
  *
  * @tparam T The type of the output generated by this Task (ie: DataFrame, RDD[(String, String)], etc.)
  */
