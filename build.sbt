...
libraryDependencies += "org.apache.spark" %% "spark-core" % "2.0.2" % "provided" exclude("org.apache.hadoop", "hadoop-client")
...
libraryDependencies += "org.apache.hadoop" % "hadoop-client" % "2.7.3" % "provided"  excludeAll ExclusionRule(organization = "javax.servlet")
libraryDependencies += "org.eclipse.jetty" % "jetty-webapp" % "9.3.14.v20161028" % "provided"
